...
const RECENTLY_VIEWED = [
  {
    ...
    badge: "Popular",
    image:
      "https://images.unsplash.com/photo-1623428454614-abaf00244e52?w=400&q=80",
  },
  {
    id: 12,
    name: "Bhujia",
...
const PROMO_BANNERS = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1623428454614-abaf00244e52?w=800&q=80",
    dark: false,
    bg: "#FDF6EC",
    accent: "#C97D3A",
  },
  ...
  const staticReviews = [
    {
      name: "Dishant Mali",
      rating: 5,
      text: "Absolutely love the authentic taste! The sweets were fresh, perfectly packed, and delivered right on time.",
    },
    {
      name: "Rahul Sharma",
      rating: 4,
      text: "Great coffee selection. The UI is very smooth. Delivery was a bit slow, but the quality makes up for it.",
    },
    {
      name: "Priyal Patel",
      rating: 5,
      text: "Best place to get local Gujarati delicacies. The vendor responsiveness is top-notch. Will definitely order again!",
    },
    {
      name: "Amit Kumar",
      rating: 5,
      text: "The user interface is so smooth and the wishlist feature makes it so easy to save my favorite items.",
    },
    {
      name: "Sneha Desai",
      rating: 4,
      text: "Really good experience overall. The roasted blends are incredibly aromatic.",
    },
  ];
    ...
    if (isAuthenticated) {
      ...
      if (existingItem) {
        if (existingItem.quantity + 1 > product.stock_quantity) {
          return toast.error(
            `Cannot add. Only ${product.stock_quantity} available.`,
          );
        }
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-32 text-center text-[#5A3825]">
        <div className="inline-flex flex-col items-center gap-4">
          ...
          <span className="text-lg font-medium text-[#5A3825]/70">
        ...
        return (
          ...
          >
            ...
            <div className="relative aspect-square bg-[#FAF8F5] overflow-hidden flex items-center justify-center">
              ...
              {/* Wishlist btn */}
              <button type="button" onClick={(e) => handleToggleWishlist(e, p)} className="absolute top-2 right-2 p-2 z-20">
                <svg
                  className={`w-6 h-6 transition-colors duration-300 ${isWishlisted ? "text-red-500 fill-current" : "text-gray-300 fill-none hover:text-red-400"}`}
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                  <path
            ...
            <div className="p-3.5">
              ...
              <div className="flex items-baseline gap-2 flex-wrap">
                <span className="text-[#2C1E16] font-bold text-base">
                ...
                {discount && discount > 0 && (
                  <span className="text-[#E8532A] text-xs font-semibold">
                    {discount}% off
                  </span>
                )}
              </div>
              ...
              {/* Free delivery tag */}
              {Number(p.price) >= 199 && (
                <p className="text-green-700 text-[10px] font-medium mt-1.5">
                  ✓ Free Delivery
                </p>
              )}
            </div>
    ...
    <div className="font-sans bg-[#F7F2EC] pb-16">
          ...
          <div className="animate-scroll hover-pause flex items-center cursor-pointer">
            {data.offers && data.offers.length > 0
              ? [
                  ...
                  <div
                    key={idx}
                    className="flex items-center mx-6 text-sm md:text-base font-medium tracking-wide"
                  >
                    <span className="bg-white text-[#5A3825] px-3 py-0.5 rounded-full text-xs font-bold uppercase mr-3 shadow-sm">
                      LIVE OFFER
                    </span>
              ...
              : [...Array(10)].map((_, idx) => (
                  <div
                    key={idx}
                    className="flex items-center mx-6 text-sm font-medium"
                  >
                    <span className="bg-white text-[#5A3825] px-3 py-0.5 rounded-full text-xs font-bold uppercase mr-3">
                      WELCOME
                    </span>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 mt-4">
        <div className="text-center mb-7">
          <span className="text-[#A87C51] font-bold tracking-widest uppercase text-xs">
            Browse
          </span>
          <h2 className="animate-fade-in-up text-2xl font-bold text-[#2C1E16] mt-1">
            Shop by Category
          </h2>
        </div>
        <div className="animate-fade-in-up delay-2 flex overflow-x-auto pb-4 gap-5 scrollbar-hide justify-center md:flex-wrap">
          {data.categories.map((cat) => (
            <Link
              ...
              className="cat-item min-w-[110px] flex flex-col items-center group"
            >
              <div className="w-[90px] h-[90px] rounded-full bg-white flex items-center justify-center overflow-hidden border-2 border-[#A87C51]/20 group-hover:border-[#A87C51] transition-all duration-300 shadow-sm group-hover:shadow-[0_4px_16px_rgba(168,124,81,0.25)] mb-3">
                {cat.image ? (
                  ...
                  <span className="text-[#5A3825] font-bold text-xl">
                    {cat.name.charAt(0)}
                  </span>
                )}
              </div>
              <h3 className="text-[#2C1E16] font-semibold text-xs text-center group-hover:text-[#A87C51] transition-colors">
                {cat.name}
              </h3>
            </Link>
          ))}
      ...
      <div className="max-w-7xl mx-auto px-4 mb-12">
        ...
        >
          ...
          {PROMO_BANNERS.map((banner, idx) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  backgroundImage: `radial-gradient(${banner.dark ? "#A87C51" : "#5A3825"} 1px, transparent 1px)`,
                  backgroundSize: "20px 20px",
                  opacity: banner.dark ? 0.06 : 0.04,
                }}
              />
              ...
              />
              <div
                className="absolute -left-8 -bottom-10 w-56 h-56 rounded-full pointer-events-none"
              ...
              <div className="absolute right-0 top-0 h-full w-1/2 overflow-hidden">
                <img
                  ...
                  style={{
                    transform:
                      idx === bannerSlide ? "scale(1.1)" : "scale(1.05)",
                    mixBlendMode: banner.dark ? "luminosity" : "multiply",
                  }}
                />
                <div
              ...
              <div className="relative z-10 p-8 md:p-12 max-w-[58%]">
                ...
                <h3
                  className={`text-3xl lg:text-4xl font-black mb-3 leading-[1.1] tracking-tight ${banner.dark ? "text-white" : "text-[#2C1E16]"}`}
                >
                  {banner.title.split("\n").map((line, i) => (
                    <span key={i}>
                      {line}
                ...
                <p
                  className={`mb-6 text-sm leading-relaxed ${banner.dark ? "text-white/45" : "text-[#5A3825]/70"}`}
                >
                  {banner.desc}
                </p>
                <Link
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = banner.accent;
                    e.currentTarget.style.color = banner.dark
                      ? "#1A110A"
                      : "#fff";
                  ...
                  onMouseLeave={(e) => {
                    if (banner.dark) {
                      ...
                      e.currentTarget.style.color = banner.accent;
                      e.currentTarget.style.border = `1px solid ${banner.accent}`;
                    } else {
                      e.currentTarget.style.background = "#2C1E16";
          ...
          <button
            onClick={() =>
              goBannerSlide(
                (bannerSlide - 1 + PROMO_BANNERS.length) % PROMO_BANNERS.length,
              )
            }
          ...
          <button
            onClick={() =>
              goBannerSlide((bannerSlide + 1) % PROMO_BANNERS.length)
            }
            ...
            {PROMO_BANNERS.map((_, idx) => (
              <button
                ...
                style={{
                  ...
                  height: "7px",
                  background:
                    idx === bannerSlide ? "#A87C51" : "rgba(168,124,81,0.35)",
                }}
              />
            ))}
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 mb-14">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {MINI_BANNERS.map((b, i) => (
            ...
            >
              <div className="absolute -right-4 -bottom-4 text-6xl opacity-20 select-none">
                {b.emoji}
              </div>
              <span className={`text-3xl`}>{b.emoji}</span>
              <div>
                <p
                  className={`font-bold text-sm ${b.dark ? "text-white" : "text-[#2C1E16]"}`}
                >
                  {b.label}
                </p>
                <p
                  className={`text-xs mt-0.5 ${b.dark ? "text-[#A87C51]" : "text-[#5A3825]/70"}`}
                >
                  {b.sub}
                </p>
              </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 px-6 py-5 bg-gradient-to-r from-[#2C1E16] to-[#5A3825]">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[#A87C51] text-xs font-medium">
            ...
            <div className="flex items-center gap-2">
              <span className="text-white/70 text-xs font-medium uppercase tracking-wider mr-1">
                Ends in
              </span>
              {[pad(countdown.h), pad(countdown.m), pad(countdown.s)].map(
                (unit, i) => (
                  <span key={i} className="flex items-center gap-1">
                    <span className="bg-white text-[#2C1E16] font-black text-lg px-2.5 py-1 rounded-lg min-w-[40px] text-center tabular-nums">
                      {unit}
                    </span>
                    {i < 2 && (
              ...
              <div className="flex flex-col items-center ml-1 gap-y-[3px]">
                {["HRS", "MIN", "SEC"].map((l, i) => (
                  <span
                    key={i}
                    className="text-white/40 text-[8px] font-bold tracking-wider"
                  >
                    {l}
                  </span>
                ))}
              ...
              >
                <div className="relative aspect-square bg-[#FAF8F5] rounded-xl overflow-hidden mb-3 border border-[#A87C51]/10">
                  <img
                    src={p.image}
                    alt={p.name}
                    className="w-full h-full object-cover mix-blend-multiply group-hover:scale-105 transition-transform duration-400"
                  />
                  <span className="absolute top-2 left-2 bg-[#E8532A] text-white text-[10px] font-black px-2 py-0.5 rounded">
                    {p.discount}% OFF
                  </span>
                </div>
                <h4 className="text-[#2C1E16] font-semibold text-xs truncate group-hover:text-[#A87C51] transition-colors">
                  {p.name}
                </h4>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div>
            <div className="flex items-center justify-between mb-5">
              <h2 className="animate-fade-in-up text-2xl font-bold text-[#2C1E16] flex items-center gap-2">
                🔥 Trending
              </h2>
              <Link
                to="/shop"
                className="text-[#A87C51] text-sm font-semibold hover:text-[#5A3825] transition-colors"
              >
                View All →
              </Link>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-14 mt-2">
        <div className="bg-white rounded-3xl border border-[#A87C51]/15 px-6 py-8 shadow-sm">
          <div className="flex flex-col items-center mb-8">
            <span className="text-[#A87C51] font-bold tracking-widest uppercase text-xs mb-1">
              Our Collection
            </span>
            <h2 className="animate-fade-in-up text-3xl font-bold text-[#2C1E16] mb-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            },
            {
              ...
              sub: "Sourced from verified vendors",
            },
          ].map((item, i) => (
            <div
              key={i}
              className="bg-white rounded-2xl border border-[#A87C51]/15 p-5 flex items-center gap-4 shadow-sm hover:shadow-md hover:border-[#A87C51]/40 transition-all duration-300"
            >
      ...
      <div className="py-16 bg-[#FAF8F5] border-y border-[#A87C51]/20 mt-4 relative">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10 animate-fade-in-up">
            ...
            <h2 className="text-3xl font-bold text-[#2C1E16] mt-2">
              Trusted Top Vendors
            </h2>
          </div>
          <div
          ...
          >
            {data.vendors && data.vendors.length > 0 ? (
              [...data.vendors, ...data.vendors, ...data.vendors].map(
                (vendor, idx) => (
                  <div
                    key={idx}
                  ...
                  >
                    ...
                    <h3 className="font-bold text-[#2C1E16] text-lg text-center group-hover:text-[#A87C51] transition-colors">
                      {vendor.shop_name}
                    </h3>
                  </div>
                ),
              ...
              <p className="text-gray-500 text-center w-full">
                No top vendors available at the moment.
              </p>
            )}
          </div>
          <div className="flex justify-center gap-4 mt-5">
            <button
              onClick={scrollLeft}
              className="w-11 h-11 rounded-full bg-white shadow-md border border-gray-100 flex items-center justify-center text-[#2C1E16] hover:bg-[#FAF8F5] transition-all duration-300 active:scale-95"
            >
              <svg
                className="w-5 h-5"
                fill="none"
            ...
            return (
              ...
              >
                <div className="aspect-square rounded-xl overflow-hidden bg-[#FAF8F5] border border-[#A87C51]/15 mb-2.5 relative">
                  ...
                  />
                  {discount && discount > 0 && (
                    <span className="absolute top-1.5 left-1.5 bg-[#E8532A] text-white text-[9px] font-black px-1.5 py-0.5 rounded">
                      {discount}% OFF
                    </span>
                  )}
                </div>
                <h4 className="text-xs font-semibold text-[#2C1E16] truncate group-hover:text-[#A87C51] transition-colors">
                  {p.name}
                </h4>
      ...
      <div className="py-16 bg-white relative">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div
            ...
            className="flex overflow-x-auto gap-5 pb-6 pt-4 px-2 w-full snap-x snap-mandatory [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
          >
            {[...staticReviews, ...staticReviews, ...staticReviews].map(
              (review, idx) => (
                <div
                  key={idx}
                ...
                >
                  <div className="flex items-center gap-4 mb-5">
                    ...
                    <div>
                      <h3 className="font-bold text-[#2C1E16] text-base group-hover:text-[#A87C51] transition-colors">
                        {review.name}
                      </h3>
                      <div className="flex text-yellow-400 mt-0.5">
                        {[...Array(5)].map((_, i) => (
                          <svg
                            key={i}
                            className={`w-3.5 h-3.5 ${i < review.rating ? "fill-current" : "text-gray-200 fill-current"}`}
                            viewBox="0 0 20 20"
                          >
                  ...
                  <p className="text-gray-500 italic text-sm leading-relaxed relative">
                    <span className="text-4xl text-[#A87C51]/20 absolute -top-4 -left-2 font-serif">
                      "
                    </span>
      ...
      <div className="bg-gradient-to-r from-[#2C1E16] to-[#5A3825] py-12 mt-4">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <span className="text-[#A87C51] uppercase tracking-widest text-xs font-bold">
            Stay Updated
          </span>
          <h3 className="text-white font-black text-2xl md:text-3xl mt-2 mb-2">
            Get Exclusive Deals in Your Inbox
          </h3>
          <p className="text-white/50 text-sm mb-7">
            Subscribe and get 10% off your first order, plus weekly offers.
          </p>
